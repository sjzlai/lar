...
<div class="result_wrap">
    <form action="{{url('admin/goods/'.$data->g_id)}}" method="post" enctype="multipart/form-data">
        ...
        <table class="add_tab">
            ...
            <tr>
                ...
                <td>
                    <select name="gc_id">
                        @foreach($field as $d)
                            <option value="{{$d->gc_id}}">{{$d->gc_title}}</option>
                        @endforeach
                    </select>
                </td>
            </tr>
            <tr>
                ...
                <td>
                    <input type="text" class="lg" name="g_name" value="{{$data->g_name}}">
                </td>
            </tr>
           {{-- <tr>
                <th>主图：</th>
            ...
            <tr>
                <th>商品简介：</th>
                <td>
                    <textarea name="g_jian">{{$data->g_jian}}</textarea>
                </td>
            </tr>
            <tr>
